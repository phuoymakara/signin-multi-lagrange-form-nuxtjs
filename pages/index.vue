<template>
  <div>
    <Header/>
    <man class="md:w-[80%] lg:w-[80%] md:mx-auto lg:mx-auto w-full flex justify-center">
      <!-- <h1>Hello</h1>
      <h2>{{ $t('welcome') }}</h2> -->
      <div class="w-full grid md:grid-cols-2 my-6 rounded-lg lg:grid-cols-2 p-2 border gap-12">
       <div class="md:px-4 lg:px-24  p-6">
         <form class="space-y-6" action="#" method="POST">
          <h1 class="text-[32px] font-extrabold">{{$t('signin')}}</h1>
          <p>{{$t('not_member')}} <strong class="text-blue-600 cursor-pointer hover:text-blue-300">{{$t('free_trail')}}</strong></p>
        <div>
        ...
        <div class="md:block lg:block xl:block hidden">
          <img class="rounded-tr-lg  rounded-br-lg w-full h-full object-cover" src="https://images.unsplash.com/photo-1496917756835-20cb06e75b4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1908&q=80" alt="">
        </div>
      </div>
    </man>
  </div>
